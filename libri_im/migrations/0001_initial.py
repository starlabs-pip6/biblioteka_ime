# Generated by Django 3.2.4 on 2021-08-19 20:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('events', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), blank=True, default=list, null=True, size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nr_books', models.IntegerField()),
                ('books', django.contrib.postgres.fields.ArrayField(base_field=models.BigIntegerField(), blank=True, null=True, size=None)),
            ],
        ),
        migrations.CreateModel(
            name='Sirtar',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('toBook', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='libri_im.book')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='relation1', to=settings.AUTH_USER_MODEL)),
                ('user2', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='relation2', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Progress',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('toBook', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='libri_im.book')),
                ('toUser', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ntfcToUser', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ntfcUser', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='FriendRequest',
